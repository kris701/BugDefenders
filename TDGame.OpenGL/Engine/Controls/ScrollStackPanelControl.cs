...
namespace TDGame.OpenGL.Engine.Controls
{
    public class ScrollStackPanelControl : StackPanelControl
    {
        ...
        public Texture2D ScrollBarIndicatorFillColor { get; set; } = BasicTextures.Gray;
        public string ScrollButtonsFillColorName { get; set; } = "";
        public Texture2D ScrollButtonsFillColor { get; set; } = BasicTextures.Gray;
        public string ScrollButtonsClickedFillColorName { get; set; } = "";
        public Texture2D ScrollButtonsClickedFillColor { get; set; } = BasicTextures.White;
