...
#if DEBUG
            AddControl(0, new BugDefenderButtonControl(Parent, clicked: (x) => SwitchView(new GameOverView(Parent, _screen, _context, _credits, _gameResult, _difficulty, _title)))
            {
                X = 0,
                Y = 0,
                Width = 50,
